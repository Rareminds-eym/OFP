...
const InstructionsPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 bg-gradient-to-b from-green-950 to-slate-900 p-8 relative overflow-hidden">
      <CircuitLines />
        ...
        <div className="absolute left-0 top-0">
          <button
            ...
            className="group p-3 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 
              border border-slate-700/50 hover:border-green-500/50 
              transform hover:-translate-y-1 hover:translate-x-1
              transition-all duration-300"
          >
            <Home className="w-5 h-5 text-slate-400 group-hover:text-green-400
          ...
          <div className="text-center">
            <button
              ...
              className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600
                hover:from-green-500 hover:to-emerald-500 text-white rounded-lg
