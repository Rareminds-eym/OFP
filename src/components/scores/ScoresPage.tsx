...
const ScoresPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 bg-gradient-to-b from-green-950 to-stone-900 p-8 relative overflow-hidden">
      <CircuitLines />
        ...
        <div className="space-y-12 pt-16">
          <div className="text-center">
            <h1
              ...
              from-green-400 via-emerald-300 to-green-400 bg-clip-text text-transparent 
