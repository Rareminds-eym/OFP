  ...
  <button
    ...
    className={`w-full flex items-center space-x-4 p-6 
      ...
      ${disabled 
        ...
        : 'bg-slate-800/50 border border-slate-700/50 hover:border-green-500/50 hover:bg-slate-700/50'
      }`}
  >
    <div className={`transform group-hover:scale-110 transition-all duration-300
      ${disabled ? 'text-slate-600' : 'text-green-400 group-hover:text-emerald-300'}`}>
